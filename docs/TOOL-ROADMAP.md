...
| 3 | HEIC → JPG | **shipped** |
| 4 | **Format convert** (PNG↔JPG, WebP…) | **shipped** — `/tools/png-to-jpg` |
...
| 6 | **Format convert** (PNG↔JPG, WebP…) | [specs/05-format-convert.md](./specs/05-format-convert.md) | **shipped (v1)** — `/tools/png-to-jpg` |
